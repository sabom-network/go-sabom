...
// Package graphql provides a GraphQL interface to Sabom node data.
package graphql
...
// Account represents an Sabom account at a particular block.
type Account struct {
	r             *Resolver
...
// Transaction represents an Sabom transaction.
...
// Block represents an Sabom block.
...
type CallData struct {
	From                 *common.Address // The Sabom address the call is from.
	To                   *common.Address // The Sabom address the call is to.
