Name "gsab ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/sabom-network/go-sabom/issues"
!define UPDATEURL "https://github.com/sabom-network/go-sabom/releases"
!define ABOUTURL "https://github.com/sabom-network/go-sabom#sabom-go"
...
# Install gsab binary
Section "Gsab" GSAB_IDX
  SetOutPath $INSTDIR
  file {{.Gsab}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gsab.exe"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gsab.exe" "attach"
  createShortCut "$SMPROGRAMS\${APPNAME}\Uninstall.lnk" "$INSTDIR\uninstall.exe"

  # Firewall - remove rules (if exists)
  SimpleFC::AdvRemoveRule "Gsab incoming peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gsab outgoing peers (TCP:30303)"
  SimpleFC::AdvRemoveRule "Gsab UDP discovery (UDP:30303)"

  # Firewall - add rules
  SimpleFC::AdvAddRule "Gsab incoming peers (TCP:30303)" ""  6 1 1 2147483647 1 "$INSTDIR\gsab.exe" "" "" "Sabom" 30303 "" "" ""
  SimpleFC::AdvAddRule "Gsab outgoing peers (TCP:30303)" ""  6 2 1 2147483647 1 "$INSTDIR\gsab.exe" "" "" "Sabom" "" 30303 "" ""
  SimpleFC::AdvAddRule "Gsab UDP discovery (UDP:30303)" "" 17 2 1 2147483647 1 "$INSTDIR\gsab.exe" "" "" "Sabom" "" 30303 "" ""

  # Set default IPC endpoint (https://github.com/ethereum/EIPs/issues/147)
  ${EnvVarUpdate} $0 "SABOM_SOCKET" "R" "HKLM" "\\.\pipe\gsab.ipc"
  ${EnvVarUpdate} $0 "SABOM_SOCKET" "A" "HKLM" "\\.\pipe\gsab.ipc"
...
Function GetInstalledSize
  ...
  ${if} ${SectionIsSelected} ${GSAB_IDX}
    SectionGetSize ${GSAB_IDX} $0
