...
# 1. install gsab for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gsab
# 5. create gsab, attach and uninstall start menu entries
# 6. configures the registry that allows Windows to manage the package through its platform tools
# 7. adds the environment system wide variable SABOM_SOCKET
...
!define GROUPNAME "Sabom"
!define APPNAME "Gsab"
!define DESCRIPTION "Official Go implementation of the Sabom protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gsab is installed global
