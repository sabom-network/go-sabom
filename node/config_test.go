...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gsab.ipc", false, filepath.Join(os.TempDir(), "gsab.ipc")},
		{"data", "gsab.ipc", false, "data/gsab.ipc"},
		{"data", "./gsab.ipc", false, "./gsab.ipc"},
		{"data", "/gsab.ipc", false, "/gsab.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gsab.ipc", true, `\\.\pipe\gsab.ipc`},
		{"data", "gsab.ipc", true, `\\.\pipe\gsab.ipc`},
		{"data", `\\.\pipe\gsab.ipc`, true, `\\.\pipe\gsab.ipc`},
	}
