...
// Package ethclient provides a client for the Sabom RPC API.
package ethclient
...
// Client defines typed wrappers for the Sabom RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) SyncProgress(ctx context.Context) (*sabom.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (sabom.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q sabom.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q sabom.FilterQuery, ch chan<- types.Log) (sabom.Subscription, error) {
	arg, err := toFilterArg(q)
	if err != nil {
		return nil, err
	}
...
func toFilterArg(q sabom.FilterQuery) (interface{}, error) {
...
func (ec *Client) CallContract(ctx context.Context, msg sabom.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) CallContractAtHash(ctx context.Context, msg sabom.CallMsg, blockHash common.Hash) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) PendingCallContract(ctx context.Context, msg sabom.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) FeeHistory(ctx context.Context, blockCount uint64, lastBlock *big.Int, rewardPercentiles []float64) (*sabom.FeeHistory, error) {
...
func (ec *Client) EstimateGas(ctx context.Context, msg sabom.CallMsg) (uint64, error) {
...
func toCallArg(msg sabom.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
...
func (p *rpcProgress) toSyncProgress() *sabom.SyncProgress {
	if p == nil {
		return nil
	}
	return &sabom.SyncProgress{
