...
import (
	...
	"github.com/sabom-network/go-sabom/internal/jsre"
	"github.com/sabom-network/go-sabom/internal/jsre/deps"
	"github.com/sabom-network/go-sabom/internal/web3ext"
...
type Config struct {
	...
	Client   *rpc.Client         // RPC client to execute Sabom requests through
...
// Welcome show summary of current Gsab instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	message := "Welcome to the Gsab JavaScript console!\n\n"

	// Print some generic Gsab metadata
