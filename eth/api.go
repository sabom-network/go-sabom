...
// SabomAPI provides an API to access Sabom full node-related information.
type SabomAPI struct {
	e *Sabom
}

// NewSabomAPI creates a new Sabom protocol API for full nodes.
func NewSabomAPI(e *Sabom) *SabomAPI {
	return &SabomAPI{e}
}

// Etherbase is the address that mining rewards will be send to.
func (api *SabomAPI) Etherbase() (common.Address, error) {
	return api.e.Etherbase()
}

// Coinbase is the address that mining rewards will be send to (alias for Etherbase).
func (api *SabomAPI) Coinbase() (common.Address, error) {
	return api.Etherbase()
}

// Hashrate returns the POW hashrate.
func (api *SabomAPI) Hashrate() hexutil.Uint64 {
	return hexutil.Uint64(api.e.Miner().Hashrate())
}

// Mining returns an indication if this node is currently mining.
func (api *SabomAPI) Mining() bool {
...
func NewMinerAPI(e *Sabom) *MinerAPI {
	return &MinerAPI{e}
}
...
// AdminAPI is the collection of Sabom full node related APIs for node
// administration.
...
func NewAdminAPI(eth *Sabom) *AdminAPI {
...
// DebugAPI is the collection of Sabom full node APIs for debugging the
// protocol.
...
func NewDebugAPI(eth *Sabom) *DebugAPI {
