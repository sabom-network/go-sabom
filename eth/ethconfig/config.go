...
// Defaults contains default settings for use on the Sabom main net.
var Defaults = Config{
...
type Config struct {
	...
	// If nil, the Sabom main net block is used.
	...
	// canonical chain of all remote peers. Setting the option makes gsab verify the
	...
	// send-transaction variants. The unit is sab.
	RPCTxFeeCap float64
