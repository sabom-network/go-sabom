...
import (
	...
	"github.com/sabom-network/go-sabom/p2p/msgrate"
...
// Syncer is an Sabom account and storage trie syncer based on snapshots and
...
// NewSyncer creates a new snapshot syncer to download the Sabom state over the
// snap protocol.
