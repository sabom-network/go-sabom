...
// setting up a new or managing an existing Sabom private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your Sabom private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new Sabom network down to  |")
	...
	log.Info("Administering Sabom network", "name", w.network)
