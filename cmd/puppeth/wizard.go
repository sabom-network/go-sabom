...
type wizard struct {
	...
	services map[string][]string   // Sabom services known to be running on servers
...
// converts it to an Sabom address. If an empty line is entered, the default
// value is returned.
