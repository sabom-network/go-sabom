...
import (
	...
	"github.com/sabom-network/go-sabom/internal/cmdtest"
	"github.com/sabom-network/go-sabom/rpc"
)

type testgsab struct {
	*cmdtest.TestCmd
...
func init() {
	// Run the app if we've been exec'd as "gsab-test" in runGsab.
	reexec.Register("gsab-test", func() {
...
// spawns gsab with the given command line args. If the args don't set --datadir, the
// child g gets a temporary data directory.
func runGsab(t *testing.T, args ...string) *testgsab {
	tt := &testgsab{}
	...
	// Boot "gsab". This actually runs the test binary but the TestMain
	// function will prevent any tests from running.
	tt.Run("gsab-test", args...)
