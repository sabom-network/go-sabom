...
import (
	...
	ethdownloader "github.com/sabom-network/go-sabom/eth/downloader"
	...
	"github.com/sabom-network/go-sabom/p2p/simulations"
	"github.com/sabom-network/go-sabom/p2p/simulations/adapters"
...
func newLesServerService(ctx *adapters.ServiceContext, stack *node.Node) (node.Lifecycle, error) {
	...
	sabom, err := eth.New(stack, &config)
	if err != nil {
		return nil, err
	}
	_, err = NewLesServer(stack, sabom, &config)
	if err != nil {
		return nil, err
	}
	return sabom, nil
