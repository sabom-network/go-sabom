...
import (
	...
	"github.com/sabom-network/go-sabom/common/bitutil"
	"github.com/sabom-network/go-sabom/light"
)

const (
	// bloomServiceThreads is the number of goroutines used globally by an Sabom
...
func (eth *LightSabom) startBloomHandlers(sectionSize uint64) {
