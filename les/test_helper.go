...
import (
	...
	"github.com/sabom-network/go-sabom/accounts/abi/bind/backends"
	...
	"github.com/sabom-network/go-sabom/contracts/checkpointoracle/contract"
	"github.com/sabom-network/go-sabom/core"
	"github.com/sabom-network/go-sabom/core/forkid"
	...
	"github.com/sabom-network/go-sabom/les/checkpointoracle"
	"github.com/sabom-network/go-sabom/les/flowcontrol"
	vfs "github.com/sabom-network/go-sabom/les/vflux/server"
...
func prepare(n int, backend *backends.SimulatedBackend) {
	...
	for i := 0; i < n; i++ {
		...
		case 0:
			...
			// bankUser transfers some sab to user1
		...
		case 1:
			...
			// bankUser transfers more sab to user1
		...
		case 2:
			...
			// bankUser transfer some sab to signer
			bankNonce, _ := backend.PendingNonceAt(ctx, bankAddr)
