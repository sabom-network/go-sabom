...
// This test reproduces https://github.com/sabom-network/go-sabom/issues/17837 where the
...
// It is the reproducer for https://github.com/sabom-network/go-sabom/issues/22322
...
func ipcTestClient(srv *Server, fl *flakeyListener) (*Client, net.Listener) {
	...
	endpoint := fmt.Sprintf("go-sabom-test-ipc-%d-%d", os.Getpid(), rand.Int63())
