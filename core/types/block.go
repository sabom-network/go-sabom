...
// Package types contains data types related to Sabom consensus.
package types
...
// Header represents a block header in the Sabom blockchain.
type Header struct {
...
// Block represents an entire block in the Sabom blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// EncodeRLP serializes b into the Sabom RLP block format.
