...
// NewID calculates the Sabom fork ID from the chain config, genesis hash, and head.
...
// NewIDWithChain calculates the Sabom fork ID from an existing chain instance.
