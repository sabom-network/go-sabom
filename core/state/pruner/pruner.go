...
pruning. Remember don't start the Gsab without deleting the clean trie cache
otherwise the entire database may be damaged!

Check the command description "gsab snapshot prune-state --help" for more details.
`
