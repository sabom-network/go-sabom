...
// Package state provides a caching layer atop the Sabom state trie.
package state
...
// StateDB structs within the sabom protocol are used to store anything
...
//
// Carrying over the balance ensures that Sab doesn't disappear.
...
func (s *StateDB) Copy() *StateDB {
	...
	for addr := range s.journal.dirties {
		// As documented [here](https://github.com/sabom-network/go-sabom/pull/16485#issuecomment-380438527),
