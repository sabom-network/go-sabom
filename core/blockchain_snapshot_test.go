...
// It can be used for testing that restart Gsab normally.
...
// It can be used for testing that restart Gsab after the crash.
...
// Tests a Gsab restart with valid snapshot. Before the shutdown, all snapshot
...
// Tests a Gsab was crashed and restarts with a broken snapshot. In this case the
...
// Tests a Gsab was crashed and restarts with a broken snapshot. In this case
...
// Tests a Gsab was running with snapshot enabled. Then restarts without
...
// Tests the Gsab was running with snapshot enabled and resetHead is applied.
...
// Tests the Gsab was running with a complete snapshot and then imports a few
