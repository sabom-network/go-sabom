...
// Package bind generates Sabom contract Go bindings.
//
// Detailed usage document and tutorial available on the go-sabom Wiki page:
// https://github.com/sabom-network/go-sabom/wiki/Native-DApps:-Go-bindings-to-Sabom-contracts
package bind
