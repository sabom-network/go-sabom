...
// See https://github.com/sabom-network/wiki/wiki/Web3-Secret-Storage-Definition for more information.
package keystore
...
// ImportPreSaleKey decrypts the given Sabom presale wallet and stores
