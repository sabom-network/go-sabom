...
// all blocks' seal as valid, though they still have to conform to the Sabom
// consensus rules.
...
// still have to conform to the Sabom consensus rules.
...
// they still have to conform to the Sabom consensus rules.
