...
// mapped from textual names used in the tests below to actual Sabom private
...
// address retrieves the Sabom address of a tester account by label, creating
...
func (ap *testerAccountPool) address(account string) common.Address {
	...
	// Resolve and return the Sabom address
...
func TestClique(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			// batch (https://github.com/sabom-network/go-sabom/issues/17593). Whilst this
